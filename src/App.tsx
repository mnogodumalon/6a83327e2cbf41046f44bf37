...
// <custom:imports>
const IntentSitzungPlanenPage = lazy(() => import('@/pages/intents/SitzungPlanenPage'));
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                {/* <custom:routes> */}
                <Route path="intents/sitzung-planen" element={<Suspense fallback={null}><IntentSitzungPlanenPage /></Suspense>} />
