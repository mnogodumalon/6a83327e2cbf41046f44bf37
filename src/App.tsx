...
import TagesordnungspunktePage from '@/pages/TagesordnungspunktePage';
import TagesordnungspunkteDetailPage from '@/pages/TagesordnungspunkteDetailPage';
import ProtokollePage from '@/pages/ProtokollePage';
import ProtokolleDetailPage from '@/pages/ProtokolleDetailPage';
...
const IntentProtokolErstellenPage = lazy(() => import('@/pages/intents/ProtokolErstellenPage'));
// </custom:imports>
          ...
          <ActionsProvider>
            ...
            <Routes>
              ...
              <Route element={<Layout />}>
                ...
                <Route path="tagesordnungspunkte" element={<TagesordnungspunktePage />} />
                <Route path="tagesordnungspunkte/:id" element={<TagesordnungspunkteDetailPage />} />
                <Route path="protokolle" element={<ProtokollePage />} />
                <Route path="protokolle/:id" element={<ProtokolleDetailPage />} />
                ...
                <Route path="intents/protokoll-erstellen" element={<Suspense fallback={null}><IntentProtokolErstellenPage /></Suspense>} />
                {/* </custom:routes> */}
              </Route>
            </Routes>
            </LocaleGate>
