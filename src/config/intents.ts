...
// <custom:intent-imports>
import { IconMailForward, IconFileText } from '@tabler/icons-react';
// </custom:intent-imports>
...
export const INTENTS: IntentLink[] = [
  // <custom:intents>
  { path: '/intents/sitzung-einladen', label: { de: 'Sitzung einladen', en: 'Invite to meeting' }, icon: IconMailForward, description: 'Sitzung anlegen, Tagesordnung erfassen und Mitglieder einladen' },
  { path: '/intents/protokoll-erfassen', label: { de: 'Protokoll erfassen', en: 'Record minutes' }, icon: IconFileText, description: 'Protokoll zu einer Sitzung anlegen und freigeben' },
  // </custom:intents>
];
