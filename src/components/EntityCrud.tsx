          ...
          if (top.type === 'mitglieder') {
            return (
              <>
                ...
                <MitgliederDetails
                  record={top.record}
                  sitzungenEingeladeneMitgliederList={data.sitzungen}
                  onOpenSitzungenEingeladeneMitglieder={(r) => detailSitzungen(r, true)}
                  onAddSitzungenEingeladeneMitglieder={() => setSitzungenDialog({ defaults: { eingeladene_mitglieder: [createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id)] } })}
                  sitzungenAngemeldeteMitgliederList={data.sitzungen}
                  onOpenSitzungenAngemeldeteMitglieder={(r) => detailSitzungen(r, true)}
                  onAddSitzungenAngemeldeteMitglieder={() => setSitzungenDialog({ defaults: { angemeldete_mitglieder: [createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id)] } })}
                  tagesordnungspunkteList={data.tagesordnungspunkte}
                  ...
                  protokolleProtokollfuehrerList={data.protokolle}
                  onOpenProtokolleProtokollfuehrer={(r) => detailProtokolle(r, true)}
                  onAddProtokolleProtokollfuehrer={() => setProtokolleDialog({ defaults: { protokollfuehrer: createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id) } })}
                  protokolleAnwesendeMitgliederList={data.protokolle}
                  onOpenProtokolleAnwesendeMitglieder={(r) => detailProtokolle(r, true)}
                  onAddProtokolleAnwesendeMitglieder={() => setProtokolleDialog({ defaults: { anwesende_mitglieder: [createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id)] } })}
                  ...
                  notizenErstellerList={data.notizen}
                  onOpenNotizenErsteller={(r) => detailNotizen(r, true)}
                  onAddNotizenErsteller={() => setNotizenDialog({ defaults: { ersteller: createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id) } })}
