            ...
            return (
              <>
                ...
                <MitgliederDetails
                  ...
                  sitzungenList2={data.sitzungen}
                  onOpenSitzungen2={(r) => detailSitzungen(r, true)}
                  onAddSitzungen2={() => setSitzungenDialog({ defaults: { angemeldete_mitglieder: [createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id)] } })}
                  tagesordnungspunkteList={data.tagesordnungspunkte}
                  ...
                  protokolleList2={data.protokolle}
                  onOpenProtokolle2={(r) => detailProtokolle(r, true)}
                  onAddProtokolle2={() => setProtokolleDialog({ defaults: { anwesende_mitglieder: [createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id)] } })}
                  ...
                  notizenList2={data.notizen}
                  onOpenNotizen2={(r) => detailNotizen(r, true)}
                  onAddNotizen2={() => setNotizenDialog({ defaults: { mitglied: createRecordUrl(APP_IDS.MITGLIEDER, top.record.record_id) } })}
                />
              </>
            );
          }
