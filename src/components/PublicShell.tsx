...
import { t } from '@/i18n';
import { isPreviewRequest } from '@/lib/publicClient';
...
export function PublicShell({ title, description, wide, fullBleed, loading, unavailable, children }: PublicShellProps) {
  ...
  // Owner preview of a draft (`?preview=1`). Deliberately loud and sticky:
  // a submit from here creates a REAL record, and the page otherwise looks
  // exactly like the live one — which is the point, and the risk.
