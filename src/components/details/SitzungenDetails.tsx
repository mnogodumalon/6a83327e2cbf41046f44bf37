...
export interface SitzungenDetailsProps {
  ...
  /** 1:N „Tagesordnungspunkte" (sitzung): VOLLE Liste — der Block filtert auf diesen Record. */
  ...
  /** 1:N „Protokolle" (sitzung): VOLLE Liste — der Block filtert auf diesen Record. */
  ...
  /** 1:N „Notizen" (sitzung): VOLLE Liste — der Block filtert auf diesen Record. */
  notizenList: Notizen[];
