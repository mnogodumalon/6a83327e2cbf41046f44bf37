...
export interface TagesordnungspunkteDetailsProps {
  ...
  /** 1:N „Feedback" (tagesordnungspunkt): VOLLE Liste — der Block filtert auf diesen Record. */
  ...
  onAddFeedback: () => void;
  /** 1:N „Notizen" (tagesordnungspunkt): VOLLE Liste — der Block filtert auf diesen Record. */
  notizenList: Notizen[];
