  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'sitzung': (
      <div key="sitzung" className="space-y-1.5">
        ...
        <Combobox
          id="sitzung"
          placeholder="Zu welcher Sitzung gehört das Protokoll?"
    ...
    'erstellungsdatum': (
      <div key="erstellungsdatum" className="space-y-1.5">
        ...
        <DatePicker
          id="erstellungsdatum"
          placeholder="Wann wurde das Protokoll erstellt?"
          mode="date"
    ...
    'protokollfuehrer': (
      <div key="protokollfuehrer" className="space-y-1.5">
        ...
        <Combobox
          id="protokollfuehrer"
          placeholder="Wer hat das Protokoll geführt?"
    ...
    'zusammenfassung': (
      <div key="zusammenfassung" className="space-y-1.5">
        ...
        <Textarea
          id="zusammenfassung"
          placeholder="Wesentliche Ergebnisse, Entscheidungen, Diskussionspunkte..."
    ...
    'beschluesse': (
      <div key="beschluesse" className="space-y-1.5">
        ...
        <Textarea
          id="beschluesse"
          placeholder="Alle gefassten Beschlüsse, jeweils mit Ergebnis und Verantwortung..."
