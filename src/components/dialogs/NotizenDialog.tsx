  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'titel': (
      <div key="titel" className="space-y-1.5">
        ...
        <Input
          id="titel"
          placeholder="z. B. Diskussion zukünftige Termine"
          value={fields.titel ?? ''}
    ...
    'notiztext': (
      <div key="notiztext" className="space-y-1.5">
        ...
        <Textarea
          id="notiztext"
          placeholder="Inhalt der Notiz, Stichpunkte, Ergebnisse..."
    ...
    'datum': (
      <div key="datum" className="space-y-1.5">
        ...
        <DatePicker
          id="datum"
          placeholder="Notiz vom welchen Datum?"
          mode="date"
    ...
    'sitzung': (
      <div key="sitzung" className="space-y-1.5">
        ...
        <Combobox
          id="sitzung"
          placeholder="Gehört zu welcher Sitzung?"
    ...
    'tagesordnungspunkt': (
      <div key="tagesordnungspunkt" className="space-y-1.5">
        ...
        <Combobox
          ...
          placeholder="Gehört zu welchem Punkt?"
    ...
    'protokoll': (
      <div key="protokoll" className="space-y-1.5">
        ...
        <Combobox
          id="protokoll"
          placeholder="Gehört zu welchem Protokoll?"
    ...
    'mitglied': (
      <div key="mitglied" className="space-y-1.5">
        ...
        <Combobox
          id="mitglied"
          placeholder="Gehört zu welchem Mitglied?"
          items={mitgliederListAll.map(r => ({
            id: r.record_id,
            label: String(r.fields.vorname ?? r.record_id),
          }))}
