  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'titel': (
      <div key="titel" className="space-y-1.5">
        ...
        <Input
          id="titel"
          placeholder="z. B. Folgeaufgabe: Bericht bis 15.9."
          value={fields.titel ?? ''}
    ...
    'notiztext': (
      <div key="notiztext" className="space-y-1.5">
        ...
        <Textarea
          id="notiztext"
          placeholder="Inhalte, Gedanken, Aufgaben, Notizen..."
    ...
    'sitzung': (
      <div key="sitzung" className="space-y-1.5">
        ...
        <Combobox
          id="sitzung"
          placeholder="Bezug zu welcher Sitzung?"
    ...
    'tagesordnungspunkt': (
      <div key="tagesordnungspunkt" className="space-y-1.5">
        ...
        <Combobox
          ...
          placeholder="Bezug zu welchem TOP?"
    ...
    'protokoll': (
      <div key="protokoll" className="space-y-1.5">
        ...
        <Combobox
          id="protokoll"
          placeholder="Bezug zu welchem Protokoll?"
    ...
    'mitglied': (
      <div key="mitglied" className="space-y-1.5">
        ...
        <Combobox
          id="mitglied"
          placeholder="Bezug zu welchem Mitglied?"
          items={mitgliederListAll.map(r => ({
            id: r.record_id,
            label: String(r.fields.vorname ?? r.record_id),
          }))}
