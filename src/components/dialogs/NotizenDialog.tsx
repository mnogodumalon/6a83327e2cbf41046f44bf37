  ...
  const fieldBlocks: Record<string, React.ReactNode> = {
    'titel': (
      <div key="titel" className="space-y-1.5">
        ...
        <Input
          id="titel"
          placeholder="z. B. Personalentwicklung Q3"
          value={fields.titel ?? ''}
    ...
    'notiztext': (
      <div key="notiztext" className="space-y-1.5">
        ...
        <Textarea
          id="notiztext"
          placeholder="Inhalt der Notiz, Gedanken, Beschlüsse, Aufgaben..."
    ...
    'datum': (
      <div key="datum" className="space-y-1.5">
        ...
        <DatePicker
          id="datum"
          placeholder="Wann ist diese Notiz entstanden?"
          mode="date"
    ...
    'ersteller': (
      <div key="ersteller" className="space-y-1.5">
        ...
        <Combobox
          id="ersteller"
          placeholder="Wer hat die Notiz erstellt?"
    ...
    'sitzung': (
      <div key="sitzung" className="space-y-1.5">
        ...
        <Combobox
          id="sitzung"
          placeholder="Zu welcher Sitzung gehört die Notiz?"
    ...
    'tagesordnungspunkt': (
      <div key="tagesordnungspunkt" className="space-y-1.5">
        ...
        <Combobox
          ...
          placeholder="Zu welchem TOP gehört die Notiz?"
    ...
    'protokoll': (
      <div key="protokoll" className="space-y-1.5">
        ...
        <Combobox
          id="protokoll"
          placeholder="Zu welchem Protokoll gehört die Notiz?"
    ...
    'mitglied': (
      <div key="mitglied" className="space-y-1.5">
        ...
        <Combobox
          id="mitglied"
          placeholder="Zu welchem Mitglied gehört die Notiz?"
          items={mitgliederListAll.map(r => ({
            id: r.record_id,
            label: String(r.fields.vorname ?? r.record_id),
          }))}
