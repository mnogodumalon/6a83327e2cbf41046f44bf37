...
const HUBS = {
  "mitglieder": {
    "component": "MitgliederDetails",
    "file": "src/components/details/MitgliederDetails.tsx",
    "satellites": [
      "sitzungen",
      "sitzungen",
      "tagesordnungspunkte",
  ...
  "sitzungen": {
    "component": "SitzungenDetails",
    "file": "src/components/details/SitzungenDetails.tsx",
    "satellites": [
      "tagesordnungspunkte",
      "protokolle",
      "notizen"
